...
public class ManageDeliveryPersonJPanel extends javax.swing.JPanel {
    ...
    public ManageDeliveryPersonJPanel(JPanel userProcessContainer, EcoSystem system, DeliveryManDirectory deliveryManDirectory) {
        initComponents();
    ...
    public void populateDeliveryManList() {
        ...
        for (UserAccount ua : system.getUserAccountDirectory().getUserAccountList()) {
            for (DeliveryMan deliveryMan : deliveryManDirectory.getDeliveryManDirectory()) {
                if (deliveryMan.getDeliveryPersonId().equalsIgnoreCase(ua.getEmployee().getName())) {
                    Object[] row = new Object[5];
                    row[0] = deliveryMan.getDeliveryPersonId();
                    row[1] = deliveryMan.getDeliveryPersonName();
                    row[2] = deliveryMan.getDeliveryPersonPhoneNo();
                    row[3] = deliveryMan.getDeliveryPersonEmail();
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {addBtn, backBtn, deleteBtn, viewBtn});
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        ...
        if(count == 1){
            ...
            ViewUpdateDeliveryManJPanel viewDeliveryManJPanel = new ViewUpdateDeliveryManJPanel(system,container, deliveryMan, deliveryManDirectory);
